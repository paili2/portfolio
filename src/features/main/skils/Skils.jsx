      ...
      >
        ...
        >
          ...
          <SkilCard
            ...
            src={"css.png"}
            explanation={
              "CSS를 활용하여 웹 페이지의 레이아웃을 디자인하고, 반응형 웹사이트를 구현할 수 있습니다. 다양한 스타일링 기법을 사용하여 사용자 인터페이스(UI)를 개선하고, 웹 페이지의 시각적인 요소를 최적화할 수 있습니다."
            }
          ></SkilCard>
          <SkilCard
            skilName={"JAVASCRIPT"}
          ...
          <SkilCard
            ...
            src={"java.png"}
            explanation={
              "Java를 사용하여 강력한 서버 사이드 애플리케이션을 구축할 수 있습니다. 예를 들어, RESTful API 서버를 구현하거나 대규모 시스템과 백엔드 서비스를 안정적으로 처리할 수 있습니다."
            }
          ></SkilCard>
          <SkilCard
            justify={"end"}
            ...
            src={"springboot.png"}
            explanation={
              "Spring Boot를 사용하여 빠르고 효율적인 백엔드 애플리케이션을 개발할 수 있습니다. RESTful API를 구현하거나, 데이터베이스와의 연동을 통해 CRUD 작업을 처리할 수 있습니다. 또한, 마이크로서비스 아키텍처를 구현할 수 있습니다."
            }
          ></SkilCard>
