      ...
      >
        ...
        <div style={{ display: "flex", justifyContent: "space-between" }}>
          ...
          <Card
            ...
            text1={"AI(인공지능)활용 핀테크서비스 개발자 양성과정 수료"}
            icon2={<FaReact />}
        ...
        >
          ...
          >
            ...
            다양한 경험을 통해 팀워크와 협업의 중요성을 배우며, 최신 기술을
            활용해 효율적이고 확장 가능한 시스템을 개발하는 데 집중하고
            있습니다. 쌓은 이론적 지식과 기술적 호기심을 바탕으로, 백엔드
            개발자로서 지속적으로 성장하며 안정적인 시스템 구축에 기여하고자
            합니다. 기술적 성장을 이루며, 안정적인 서비스 제공을 위해 끊임없이
            노력하겠습니다.
          </p>
        </div>
      </div>
